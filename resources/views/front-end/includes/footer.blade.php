        ...
        <div class="row">
            <div class="col-md-3">
                <div class="footer-widget contact">
                    ...
                    <p>Email : cse@sbpgc.edu.bd</p>
                    <p>Contact : 0111111111</p>
                </div>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
                <div class="footer-widget">
                    <h4 class="footer-widget-title">Social Share</h4>
        ...
        <div class="bottom-footer">
            <div class="row">
                <div class="col-12  text-center">
                    <p class="small-text">&copy; Copyright 2021. Designed by <a href="#" class="footer-blink">We Are Developers</a></p>
                </div>
            </div> <!-- /.row -->
        </div> <!-- /.bottom-footer -->
    </div> <!-- /.container -->
